...
insert into philosophers (id, name, name_en, era, bio, main_works, theme_tags, image_url) values
  ...
  ('eeeeeeee-eeee-4eee-eeee-eeeeeeeeeeee5', '아르투어 쇼펜하우어', 'Arthur Schopenhauer', '근대 (1788-1860)', '의지와 표상으로서의 세계를 통해 염세주의 철학을 펼친 독일 철학자. 불교 사상에 영향을 받았다.', '{"works":["의지와 표상으로서의 세계","여록과 보유"]}', '{"pessimism","will","suffering","aesthetics"}', null)
on conflict (id) do nothing;
...
values
  ...
  -- Schopenhauer
  ('d7777777-7777-4777-8777-777777777777', 'eeeeeeee-eeee-4eee-eeee-eeeeeeeeeeee5', '세상은 나의 표상이다', '의지와 표상으로서의 세계', 1818, '세상은 나의 표상이다 (Die Welt ist meine Vorstellung)', '우리가 경험하는 세계는 우리의 인식이 구성한 것이다. 객관적 실재가 아닌 주관적 표상을 본다.', '갈등 상황에서 "이것은 나의 해석일 뿐"이라고 인식하기. 다른 관점도 존재함을 받아들이기', '{"prompts":["최근 내 해석이 틀렸던 경험은?","같은 사건을 다르게 본 경우는?","나의 필터는 무엇인가?"]}', '{"perception","reality","subjectivity"}', 'hard', 7, '2025-01-16', 2),

  ('d8888888-8888-4888-8888-888888888888', 'eeeeeeee-eeee-4eee-eeee-eeeeeeeeeeee5', '욕망은 고통의 근원', '의지와 표상으로서의 세계', 1818, '모든 욕망은 결핍에서 나온다. 그리고 모든 욕망은 고통이다', '욕망의 충족은 일시적 만족일 뿐, 곧 새로운 욕망이 생긴다. 욕망의 순환을 인식하는 것이 첫걸음이다.', '쇼핑 전 "이것이 진짜 필요한가, 욕망인가?" 구분하기. 24시간 규칙 적용하기', '{"prompts":["최근 채워지지 않는 욕망은?","충족 후 허무했던 경험은?","진정한 만족은 언제 느꼈나?"]}', '{"suffering","desire","buddhism"}', 'medium', 6, '2025-01-17', 4),

  ('d9999999-9999-4999-8999-999999999999', 'eeeeeeee-eeee-4eee-eeee-eeeeeeeeeeee5', '예술, 의지로부터의 해방', '의지와 표상으로서의 세계', 1818, '예술은 의지의 노역에서 벗어나 순수 직관의 상태로 들어가는 것이다', '예술 감상은 욕망과 고통에서 벗어나 순간적 평온을 준다. 몰입은 치유다.', '일주일에 한 번 순수하게 감상하는 시간 갖기: 음악, 미술, 자연', '{"prompts":["최근 완전히 몰입한 순간은?","예술이 위로가 된 경험은?","일상에서 미적 경험을 어떻게 만들까?"]}', '{"aesthetics","contemplation","relief"}', 'medium', 5, '2025-01-18', 3),
...
-- Posts (Extended)
insert into posts (id, author_id, title, content, category, tags, upvotes, downvotes, comment_count, view_count)
values
  ('p1111111-1111-4111-9111-111111111111', '11111111-1111-1111-1111-111111111111', '[오늘의 질문] 나는 무엇을 모를까?', '소크라테스식 질문을 일상에 적용해보고 싶어요. 여러분은 어떤 질문을 스스로에게 던지시나요?', 'discussion', '{"소크라테스","무지의지"}', 2, 0, 2, 15),
  ('p2222222-2222-4222-9222-222222222222', '22222222-2222-2222-2222-222222222222', '[아고라 광장] 통제 가능한 목록 써보신 분?', '에픽테토스 통제 이분법으로 업무 스트레스 줄이기 경험 공유해요. 저는 매일 아침 3가지씩 적고 있습니다.', 'discussion', '{"에픽테토스","스토아"}', 5, 0, 3, 24),
  ('p3333333-3333-4333-9333-333333333333', '33333333-3333-3333-3333-333333333333', '[철학자와 대화] 리더의 저널링 루틴 공유', '아우렐리우스 명상록 기반으로 적는 질문 리스트 공유합니다. 매일 밤 10분 투자로 하루를 정리합니다.', 'discussion', '{"마르쿠스아우렐리우스","저널링"}', 3, 0, 1, 18),
  ('p4444444-4444-4444-9444-444444444444', '11111111-1111-1111-1111-111111111111', '[질문] 니체의 영원회귀, 어떻게 이해하시나요?', '영원히 반복된다는 개념이 너무 무섭게 느껴집니다. 긍정적으로 받아들이는 방법이 있을까요?', 'question', '{"니체","영원회귀"}', 8, 1, 5, 42)
  on conflict (id) do nothing;

-- Comments (Extended)
insert into comments (id, post_id, author_id, parent_id, content, upvotes, downvotes, depth)
values
  ('c1111111-1111-4111-a111-111111111111', 'p1111111-1111-4111-9111-111111111111', '22222222-2222-2222-2222-222222222222', null, '저도 질문 리스트 만들어 공유할게요! "이것이 정말 중요한가?"가 제 핵심 질문입니다.', 1, 0, 0),
  ('c2222222-2222-4222-a222-222222222222', 'p1111111-1111-4111-9111-111111111111', '33333333-3333-3333-3333-333333333333', null, '모른다는 걸 인정하는 게 어렵지만 해보겠습니다.', 0, 0, 0),
  ('c3333333-3333-4333-a333-333333333333', 'p2222222-2222-4222-9222-222222222222', '11111111-1111-1111-1111-111111111111', null, '통제 리스트가 마음을 차분하게 하더라고요. 감사합니다!', 2, 0, 0),
  ('c4444444-4444-4444-a444-444444444444', 'p4444444-4444-4444-9444-444444444444', '22222222-2222-2222-2222-222222222222', null, '영원회귀는 "지금 이 순간을 최선을 다해 살아라"는 메시지로 받아들이면 어떨까요? 후회 없는 삶이 목표가 됩니다.', 5, 0, 0)
  on conflict (id) do nothing;

-- Votes (sample upvotes)
insert into votes (id, user_id, target_type, target_id, vote_type)
values
  ('v1111111-1111-4111-b111-111111111111', '11111111-1111-1111-1111-111111111111', 'post', 'p2222222-2222-4222-9222-222222222222', 1),
  ('v2222222-2222-4222-b222-222222222222', '22222222-2222-2222-2222-222222222222', 'post', 'p1111111-1111-4111-9111-111111111111', 1),
  ('v3333333-3333-4333-b333-333333333333', '33333333-3333-3333-3333-333333333333', 'comment', 'c1111111-1111-4111-a111-111111111111', 1),
  ('v4444444-4444-4444-b444-444444444444', '11111111-1111-1111-1111-111111111111', 'post', 'p4444444-4444-4444-9444-444444444444', 1)
...
values
  ...
  ('bkmk3333-3333-4333-c333-333333333333', '33333333-3333-3333-3333-333333333333', 'd5555555-5555-4555-8555-555555555555')
...
values
  ...
  ('h3333333-3333-4333-d333-333333333333', '22222222-2222-2222-2222-222222222222', 'd5555555-5555-4555-8555-555555555555', '너의 삶이 무한히 반복된다면', 0, 25)
  on conflict (id) do nothing;

-- Reading history
insert into reading_history (id, user_id, philostory_id, progress, last_position)
values
  ('r1111111-1111-4111-e111-111111111111', '11111111-1111-1111-1111-111111111111', 'd2222222-2222-4222-8222-222222222222', 80, 1500),
  ('r2222222-2222-4222-e222-222222222222', '22222222-2222-2222-2222-222222222222', 'd1111111-1111-4111-8111-111111111111', 40, 800),
  ('r3333333-3333-4333-e333-333333333333', '33333333-3333-3333-3333-333333333333', 'd5555555-5555-4555-8555-555555555555', 100, 2100)
...
values
  ('n1111111-1111-4111-f111-111111111111', '11111111-1111-1111-1111-111111111111', 'comment', '새 댓글이 달렸어요', '질문 글에 새로운 댓글이 있습니다', '/community/p1111111-1111-4111-9111-111111111111', false),
  ('n2222222-2222-4222-f222-222222222222', '22222222-2222-2222-2222-222222222222', 'daily_philostory', '오늘의 Philostory', '니체의 새로운 이야기가 도착했습니다', '/philostory/d5555555-5555-4555-8555-555555555555', true)
  on conflict (id) do nothing;
